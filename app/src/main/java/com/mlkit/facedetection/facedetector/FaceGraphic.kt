...
//    )
        ...
        // Draw labels
        val rectLeft = left - BOX_STROKE_WIDTH
        val rectTop = top + yLabelOffset
        val rectRight = left + textWidth + 2 * BOX_STROKE_WIDTH
        val rectBottom = top
//        Log.d("FaceRect","\n left:$left \n" +
//                " top:$top\n" +
//                " right:$right\n" +
//                " bottom:$bottom")
    ...
    companion object {
        ...
        fun getBigRect(canvas: Canvas): Rect {
            return Rect(
                canvas.width / 6,
                canvas.height / 4,
                canvas.width - canvas.width / 6, (canvas.height / 1.45f).toInt()
            )
        }

        fun getBigRect(canvas: GraphicOverlay): Rect {
            return Rect(
                canvas.width / 6,
                canvas.height / 4,
                canvas.width - canvas.width / 6, (canvas.height / 1.45f).toInt()
