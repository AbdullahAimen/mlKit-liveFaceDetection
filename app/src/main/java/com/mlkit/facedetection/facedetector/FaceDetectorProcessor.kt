...
package com.mlkit.facedetection.facedetector
...
import com.mlkit.facedetection.utillities.RectangleInfoGraphic
import com.mlkit.facedetection.utillities.VisionProcessorBase
import java.util.*
...
class FaceDetectorProcessor(
    ...
    override fun onSuccess(faces: List<Face>, graphicOverlay: GraphicOverlay) {
        val mGraphicInfo = RectangleInfoGraphic(graphicOverlay)
        graphicOverlay.add(mGraphicInfo)

        for (face in faces) {
            if (previousValue != mGraphicInfo.isFaceInside(face, graphicOverlay)) {
                iListener.isDetected(mGraphicInfo.isFaceInside(face, graphicOverlay))
                previousValue = mGraphicInfo.isFaceInside(face, graphicOverlay)
            }
