...
public class GraphicOverlay extends View {
    ...
    public abstract static class Graphic {
        ...
        public boolean isFaceInside(Face face, GraphicOverlay graphicOverlay) {
            ...
            Rect bigRect = FaceGraphic.Companion.getBigRect(graphicOverlay);
//            Log.d("isFaceInside: bigRect", "\nleft:" + bigRect.left + "\ntop:" + bigRect.top + "\nRight:" + bigRect.right + "\nbottom:" + bigRect.bottom);
//            Log.d("isFaceInside: face", "\nleft:" + left + "\ntop:" + top + "\nRight:" + right + "\nbottom:" + bottom);
            return (left > bigRect.left && top > bigRect.top &&
                    right < bigRect.right &&
                    bottom < bigRect.bottom);
        }
